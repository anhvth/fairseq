...
fairseq-hydra-train -m --config-dir examples/roberta/config/pretraining \
    ...
    optimization.update_freq=[32] dataset.batch_size=32 \
    task.tokens_per_sample=512 \
    hydra.sweep.dir=multirun/large_round2 \
    lr_scheduler.warmup_updates=100 \
    checkpoint.restore_file=/mnt/nfs-data/users/anhvth5/fairseq/multirun/large/0/checkpoints/checkpoint_270_106000.pt
